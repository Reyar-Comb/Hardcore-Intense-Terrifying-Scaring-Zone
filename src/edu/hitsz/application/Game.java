...
public class Game extends JPanel {
    ...
    private final LocalPlayerController localPlayerController;
    ...
    public Game() {
        ...
        //启动英雄机鼠标监听
        new MouseController(this, heroAircraft);
        remotePlayerController = new RemotePlayerController(this, remotePlayerAircraft);
        localPlayerController = new LocalPlayerController(this, heroAircraft);
    ...
    private void updateStateAction() {
        ...
        while ((event = Client.getInstance().pollEvent()) != null) {
            event.apply(remotePlayerController, localPlayerController);
        }
    }
